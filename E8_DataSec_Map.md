...
│          │          │          │
└▶ MFA enabled ─▶ Conditional Access ─▶ PIM and Access Reviews
└▶ Manual labels ─▶ Auto labels ─▶ Adaptive DLP and Data Map
└▶ Local backups ─▶ M365 retention ─▶ Tested restore and geo controls

4. Essential 8 Maturity Score Table

Use ASD maturity levels 0 to 3.
...
Quick wins, enforce MFA, disable unneeded macros, enable backups.

Strategic actions, auto labeling, insider risk, access reviews, restore testing.

Record context, for example, backups exist but are not tested.
